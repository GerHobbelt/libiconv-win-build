...
#define GNULIB_LOCALEDIR "/usr/local/msvc64/share/locale"
...
#define INSTALLPREFIX "/usr/local/msvc64"
...
#if defined _MSC_VER && defined _DLL && defined DLL_EXPORT && !defined(BUILD_MONOLITHIC) && !defined(ICONV_STATICLIB)
